...
\newlength{\summarybodyheight}
\setlength{\summaryregionheight}{181pt}
\setlength{\summarybodyheight}{139pt}
...
\noindent\begin{minipage}[t][\summaryregionheight][t]{\linewidth}
  \ifwithphoto
    \vfill
  ...
  \else
    \vspace*{-2pt}
    \cvsection{Summary}
    \noindent\begin{minipage}[t][\summarybodyheight][t]{\linewidth}
      {\fontsize{12}{17}\selectfont
