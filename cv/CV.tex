...
\newlength{\summaryregionheight}
\setlength{\summaryregionheight}{140pt}
...
\noindent\begin{minipage}[b][\summaryregionheight][t]{\linewidth}
  \ifwithphoto
    \begin{minipage}[c][136pt][c]{0.80\linewidth}
      \fontsize{12}{17}\selectfont
      \justifying\summarytext
    \end{minipage}\hfill
    \begin{minipage}[c][136pt][c]{0.18\linewidth}
      \raggedleft
      \raisebox{3pt}{\includegraphics[height=128pt,keepaspectratio]{../YSC-CV.jpg}}
    \end{minipage}
    \vfill
  \else
    \vspace*{-2pt}
...
\begin{tabular}{@{}>{\bfseries\raggedright\arraybackslash}m{0.505\linewidth}@{\hspace{8pt}}>{\itshape\raggedright\arraybackslash}m{0.26\linewidth}@{\hspace{8pt}}>{\raggedleft\arraybackslash}m{0.205\linewidth}@{}}
Technical University of Munich\newline School of Computation, Information and Technology & Postdoctoral Researcher & Feb. 2025 -- Now\tabularnewline[12pt]
Nanjing University\newline Software Institute & Research Assistant & Oct. 2024 -- Feb. 2025\tabularnewline[12pt]
Nanjing University\newline Software Institute & Ph.D.\newline in Software Engineering & Sep. 2020 -- Sep. 2024\tabularnewline[12pt]
ETH Zurich\newline Department of Computer Science & Visiting Ph.D.\newline in Software Engineering & Oct. 2022 -- Oct. 2023\tabularnewline[12pt]
...
{\ (Preprint)}
{Ding Yang, Yuchen Ling, \me, Zhenyu Chen, Chunrong Fang}
{}
{https://arxiv.org/abs/2609.23226}

\publication
{Agent-Integrated Software: Interaction Contracts and Continuous Assurance}
{\ (Preprint)}
{\me, Chunrong Fang\corr, Zhenyu Chen}
{}
...
{}
{Yuchen Ling, \me, Chunrong Fang\corr, Quan Zhou, Zhenyu Chen}
...
\begin{itemize}[leftmargin=1.25em,label=\textbullet,topsep=0pt,itemsep=1pt,parsep=0pt]
  ...
  \item \textbf{Conference Technical/Research Track PC Member:}
    \begin{itemize}[leftmargin=1.25em,label=\textbullet,topsep=1pt,itemsep=1pt,parsep=0pt]
      ...
      \item IEEE/ACM International Conference on Automated Software Engineering (ASE): 2025, 2026 (also ACM SRC Judge and Session Chair)
...
\begin{itemize}[leftmargin=1.25em,label=\textbullet,topsep=0pt,itemsep=2pt,parsep=0pt]
  \item \textbf{2026-09-24 \href{https://www.oii.ox.ac.uk/}{Oxford Internet Institute}:} ``Engineering Agent-Integrated Software: New Perspective of Human-Agent-Software Interaction''
...
\vspace{12pt}
\hfill\textbf{Last Updated: 2026-09-25}
